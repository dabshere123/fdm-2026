        ...
        <div style={S.persistAlert}>
          ...
          {isLC?(
            <div style={{display:"flex",flexDirection:"column",gap:10,width:"100%",maxWidth:380}}>
              <button style={{...S.bigAckBtn,background:"linear-gradient(135deg,rgba(245,158,11,0.5),rgba(202,138,4,0.5))",border:"2px solid rgba(245,158,11,0.8)",fontSize:16}} onClick={()=>ackCall(alertCall.id,role||"Admin")}>✅ ACKNOWLEDGED — SEARCHING</button>
  ...
  if(lcView) return(
    <div style={S.root}><Bg/><div style={S.panel}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 20px",position:"sticky",top:0,zIndex:20,background:"rgba(13,13,26,0.95)",backdropFilter:"blur(8px)",borderBottom:"1px solid rgba(255,255,255,0.06)"}}>
        ...
        <button style={{background:"rgba(255,255,255,0.1)",border:"2px solid rgba(255,255,255,0.25)",color:"#f1f5f9",padding:"10px 18px",borderRadius:10,cursor:"pointer",fontSize:14,fontWeight:800}} onClick={()=>setLcView(false)}>← Back</button>
      </div>
      <div style={S.cWrap}>
