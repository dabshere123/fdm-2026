    ...
    <div style={S.root}>
      ...
      <div style={{padding:'16px',display:'flex',flexDirection:'column',gap:14,overflowY:'auto',paddingBottom:32}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:8}}>
          ...
          <input ref={photoRef} type="file" accept="image/*" capture="environment" style={{display:'none'}} onChange={e=>{if(e.target.files[0]) compressPhoto(e.target.files[0],setPhoto);}}/>
        </div>
      ...
      <div style={{...S.body,paddingTop:12}}>
        ...
        {tab==='lf'&&(
          <div style={{display:'flex',flexDirection:'column',gap:10}}>
            ...
            <a href="https://fdm2026.netlify.app/lostfound" target="_blank" target="_blank" style={{...S.card,padding:'14px 16px',display:'flex',alignItems:'center',gap:12,textDecoration:'none',border:'1px solid rgba(139,92,246,0.2)',background:'rgba(139,92,246,0.06)'}}>
              <span style={{fontSize:20}}>🔍</span>
              <div style={{flex:1}}>
      ...
      <div style={S.body}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:8}}>
            ...
            <a href="https://fdm2026.netlify.app/lostfound" target="_blank" target="_blank" style={{padding:'14px 10px',borderRadius:12,border:'1px solid rgba(139,92,246,0.4)',background:'rgba(139,92,246,0.06)',cursor:'pointer',textDecoration:'none',display:'block'}}>
