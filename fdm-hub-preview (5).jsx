    ...
    <div style={{display:"flex",flexDirection:"column",gap:10,padding:"0 16px 24px"}}>
      ...
      <div style={{background:"rgba(139,92,246,0.05)",borderRadius:14,border:"1px solid rgba(139,92,246,0.2)",overflow:"hidden"}}>
        ...
        <div style={{padding:"8px"}}>
          ...
          <button style={{marginTop:8,width:"100%",padding:"8px",borderRadius:8,border:"1px solid rgba(139,92,246,0.3)",background:"rgba(139,92,246,0.08)",color:"#a78bfa",fontSize:12,fontWeight:700,cursor:"pointer"}} onClick={()=>{setView("lostfound");fetchLostFound();}}>View All Lost & Found →</button>
        </div>
      </div>
