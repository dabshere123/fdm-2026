...
const BCAST_LOC_ROLES={
  ...
  "Moon Stage":["ms","msm"],
  "Sun Stage":["sst","ssm","fsf","ss"],
  "Lagniappe Stage":["lags","lagm","lag","lagniappe stage"],
  "Lafayette Stage":["lafs","lafm","laf","lafayette stage"],
  "Family Fete Stage":["ffs","ff","family fete"],
  "Cabaret Stage":["cst","cb","cabaret"],
  "Moon Bar":["mb1","mb2","msb1","msb2"],
  "Sun Left Bar":["slb","ssbl","sbl","sun bar left help"],
  "Sun Right Bar":["srb","ssbr","sbr"],
  "Cabaret Bar":["cb","csb"],
  "Lafayette Bar":["lafb","lb"],
  "Lagniappe Bar":["lagb","lgb"],
  "Family Fete Bar":["ffb","sb"],
...
const BCAST_LOC_CHANNELS={
  ...
  "Hospitality":"Hospitality",
  "Greeter — Ingersoll Left":"AllStaff","Greeter — Ingersoll Right":"AllStaff","Greeter — Few St":"AllStaff",
};
            ...
            <div style={{display:"flex",flexDirection:"column",gap:6}}>
              ...
              <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
                {BCAST_WEATHER_TYPES.map(w=>{
                  ...
                  return(
                    <button key={w} style={{padding:"10px 14px",borderRadius:8,border:`1px solid ${sel?"rgba(239,68,68,0.6)":"rgba(255,255,255,0.1)"}`,background:sel?"rgba(239,68,68,0.15)":"rgba(255,255,255,0.03)",color:sel?"#fca5a5":"#64748b",fontSize:13,fontWeight:sel?700:400,cursor:"pointer"}}
                      onClick={()=>{
